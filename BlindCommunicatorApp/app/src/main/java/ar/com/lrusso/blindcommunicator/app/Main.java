...
import fmradio.SI47XX;
import java.io.DataInputStream;
import java.util.*;

import static fmradio.SI47XX.nodeNameDefault;
...
public class Main extends Activity implements TextToSpeech.OnInitListener
    ...
    @Override protected void onCreate(Bundle savedInstanceState)
		...
		fmradio = (TextView) findViewById(R.id.fmradio);
		camera = (TextView) findViewById(R.id.camera);

		si4705 = new SI47XX(nodeNameDefault);
	...
	@Override public void onResume()
		...
		GlobalVars.selectTextView(fmradio,false);
	...
	public void select()
		...
		switch (GlobalVars.activityItemLocation)
			...
			break;
			case 11: //FM RADIO
			GlobalVars.selectTextView(fmradio,true);
			GlobalVars.selectTextView(status,false);
			GlobalVars.selectTextView(messages,false);
			GlobalVars.talk(getResources().getString(R.string.mainFmradio));
			break;
			}
		}
