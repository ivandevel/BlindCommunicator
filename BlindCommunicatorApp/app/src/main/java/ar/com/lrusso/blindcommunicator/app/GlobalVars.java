...
public class GlobalVars extends Application
	...
	public static int detectKeyUp(int keyCode)
		...
		try
			...
			else if (keyCode == KeyEvent.KEYCODE_DPAD_CENTER) //KEYCODE_DPAD_RIGHT
				{
				return ACTION_EXECUTE;
				}
	...
	public static void volumeDown()
		...
		public static Activity getCurrentActivity() {
			...
			try {
				...
				//Do Something
				ifx = Toast.makeText(context, "Exception:" + e.toString(), Toast.LENGTH_SHORT);
				ifx.show();
			} finally {
				//Do Something
			}
		...
		//Activity act = getCurrentActivity();
			//Toast ifx = Toast.makeText(context, "Act:" + act.toString(), Toast.LENGTH_SHORT);
			// ifx.show();
		//act.finish();
