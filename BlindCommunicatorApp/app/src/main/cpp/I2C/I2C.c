...
JNIEXPORT jint JNICALL Java_fmradio_I2C_open(JNIEnv *env, jobject obj, jstring file)
{
    char fileName[64];
    const jbyte *str;
...
JNIEXPORT jint JNICALL Java_fmradio_I2C_read(JNIEnv * env, jobject obj, jint fileHander, jint slaveAddr, jintArray bufArr, jint len)
{
    jint *bufInt;
    char *bufByte;
    int res = 0, i = 0, j = 0;
...
JNIEXPORT jint JNICALL Java_fmradio_I2C_write(JNIEnv *env, jobject obj, jint fileHander,
...
JNIEXPORT void JNICALL Java_fmradio_I2C_close(JNIEnv *env, jobject obj, jint fileHander)
{
close(fileHander);
}